# ===============================================
# Ellie Byler • SEIS.631 Final Project • May 2022
# ===============================================
...
ui <- fluidPage(
  ...
  navlistPanel(
    ...
    tabPanel("About Florence Nightingale",
      ...
      fluidRow(
        column(5,
          p(tags$b(tags$a(href="https://en.wikipedia.org/wiki/Florence_Nightingale", 
            ...
            "Working at a military hospital during the",
            tags$a(href="https://en.wikipedia.org/wiki/Crimean_War", 
                "Crimean War,"),
            "Nightingale was struck",
            ...
            tags$a(href="https://curiosity.lib.harvard.edu/contagion/catalog/36-990101646750203941",
                "report."),
      ...
      tags$blockquote(em("When I am no longer even a memory, just a name,", 
        "I hope my voice may perpetuate the great work of my life. God bless my dear",
        "old comrades of Balaclava and bring them safe to shore. Florence Nightingale.")),
      br(),
    ...
    tabPanel("Explanation of Rose Diagram (video)",
      h3("A Historian Explains the Rose Diagram"),
    ...
    tabPanel("Original Rose Diagram",
      h3("Florence Nightingale Explains Her Rose Diagram"),
